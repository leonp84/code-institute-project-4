...
$(function () {
    ...
    // Populate new Column on Create Board Page
    let colCounter = 3;
    ...
    // Remove Populated Column on Create Board Page
    $('#remove-new-column').on('click', function () {
        ...
        // Users need at least 2 columns in their board
        if (colCounter == 3) {
            $('#remove-new-column').hide();
        }
    });

    // Populate new Label on Create Board Page
    let labelCounter = 2;
    ...
    // Remove Populated Label on Create Board Page
    $('#remove-new-label').on('click', function () {
        ...
        // Users need at least 1 label in their board
        if (labelCounter == 2) {
...
function extraLabel(num) {
    ...
    <div id="label-${num}">
        <hr>
        <div class="mb-3">
            <label for="id_label-${num}" class="form-label requiredField">
                Label ${num} Title
                <span class="asteriskField">*</span>
            </label>
            <button type="button" class="btn-close mb-1 remove-button-label" aria-label="Close" id="remove-button-label-${num}"></button>
            <input type="text" name="label_title" maxlength="200" class="textinput form-control" required id="id_label-${num}">
        </div>
